...
namespace ELM327_GUI
{
    public partial class InputDialog2 : Window
    {
        ...
        public InputDialog2(string prompt, string title, string defaultValue = "")
        {
            Title = title;
            Width = 600;
            Height = 150;
            ...
            inputButton.Click += (s, e) =>
            {
                ...
                inputTextBox = new TextBox { Text = "PID parancs" };
                //var buttonPanel1 = new StackPanel { Orientation = Orientation.Horizontal, HorizontalAlignment = HorizontalAlignment.Right };
                //var OKButton = new Button { Content = "Küldés", Width = 75, Margin = new Thickness(5, 0, 0, 0) };
